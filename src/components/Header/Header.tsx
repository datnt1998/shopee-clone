...
export default function Header() {
  ...
  return (
    <div className='bg-[linear-gradient(#ee4d2d,#ff7337)] pb-5 pt-2 text-xs text-white'>
      <div className='container'>
        <div className='flex justify-end'>
          ...
          >
            ...
            <span className='mx-1'>Tiếng Viết</span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
          ...
          {isAuthenticated && (
            <Popover
              className='ml-4 flex cursor-pointer items-center hover:text-white/70'
              renderPopover={
                <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                  <Link
                    to={path.profile}
            ...
            >
              <div className='mr-2 h-6 w-6 flex-shrink-0'>
                <img
                  src='https://t4.ftcdn.net/jpg/01/87/86/85/240_F_187868564_6bIwARzoG6o8ecVTEnB0EgDoodbBFPkB.jpg'
                  alt='avatar'
          ...
          <form className='col-span-9'>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                className='flex-grow border-none bg-transparent px-3 py-2 text-lg text-black outline-none'
              />
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex text-sm'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://t4.ftcdn.net/jpg/01/87/86/85/360_F_187868564_6bIwARzoG6o8ecVTEnB0EgDoodbBFPkB.jpg'
                            alt='a-123'
                        ...
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>
                            Giá treo khăn/ cọ trang điểm MEIDOO gắn tường gấp
                            gọn tiện lợi
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>₫112.000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex text-sm'>
                        <div className='flex-shrink-0'>
